                ...
                <div class="sidebar__inner">
                    ...
                    <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
                        <ul class="sidebar__menu">
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="/location/agent/order-list" class="nav-link ">
                            ...
                            <div class="card-footer py-4">
                                <nav>
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=2">2</a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=3">3</a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=4">4</a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=5">5</a>
                                        </li>
                                        <li class="page-item disabled" aria-disabled="true"><span class="page-link">...</span></li>
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=13">14</a>
                                        </li>
                                        <li class="page-item"><a class="page-link" href="/location/agent/order-list?page=14">15</a></li>
                                        <li class="page-item">
                                            <a class="page-link" href="/location/agent/order-list?page=2" rel="next" aria-label="Next &raquo;">
                                                &rsaquo;
                                            </a>
                                        </li>
                                    </ul>
