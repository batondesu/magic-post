...
export default function Header() {
    return (
        ...
        //                 <img class="h-10" src={imageAsset1} alt="" />
        //                 </a>
        //                 <ul className="hidden lg:flex lg:items-center lg:w-auto lg:space-x-12">
        //                     <li className="pt-4 pb-4">
        //                         <a
        ...
        //                 </ul>
        //                 <div className="hidden lg:block">
        //                     <a className="btn-accent hover-up-2" href="login">
        //                         Đăng nhập
        //                     </a>
        //                     <a className="btn-primary hover-up-2" href="register">
        //                         Đăng ký
        //                     </a>
        //                 </div>
        //                 <div className="lg:hidden">
        ...
        //             <div className="flex items-center mb-8">
        //                 <a className="mr-auto text-3xl font-semibold leading-none" href="#">
        //                     <img className="h-10" src="{imageAsset1}" alt="" />
        //                 </a>
        //                 <button className="navbar-close">
        //                     <svg
